...
<HEAD>
  ...
  <LINK href="<?php echo STATIC_BASE; ?>style.css" rel="stylesheet" type="text/css">
   <script language="javascript" src="<?php echo STATIC_BASE; ?>specialChars.js" charset="UTF-8">
   </script>
   ...
   <td valign=top align="left" width="155" id="menutd">
    ...
    <ul id="menu">
      ...
      <li class="<?php echo sectionType('test'); ?>">
        <a href="quiz.php?MemorySetID=<?php echo($memorySetID); ?>">Test</a></li>						
